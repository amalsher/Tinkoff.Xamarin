...
namespace Com.Google.Gson.Internal.Bind {
	...
	public sealed partial class JsonAdapterAnnotationTypeAdapterFactory : global::Java.Lang.Object, global::Com.Google.Gson.ITypeAdapterFactory {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/gson/internal/bind/JsonAdapterAnnotationTypeAdapterFactory", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (JsonAdapterAnnotationTypeAdapterFactory); }
		}
		...
		public unsafe JsonAdapterAnnotationTypeAdapterFactory (global::Com.Google.Gson.Internal.ConstructorConstructor p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (JsonAdapterAnnotationTypeAdapterFactory)) {
					SetHandle (
