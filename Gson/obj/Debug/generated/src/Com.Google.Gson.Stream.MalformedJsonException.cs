...
namespace Com.Google.Gson.Stream {
	...
	public sealed partial class MalformedJsonException : global::Java.IO.IOException {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/gson/stream/MalformedJsonException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MalformedJsonException); }
		}
		...
		public unsafe MalformedJsonException (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (MalformedJsonException)) {
					SetHandle (
		...
		public unsafe MalformedJsonException (string p0, global::Java.Lang.Throwable p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		public unsafe MalformedJsonException (global::Java.Lang.Throwable p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
