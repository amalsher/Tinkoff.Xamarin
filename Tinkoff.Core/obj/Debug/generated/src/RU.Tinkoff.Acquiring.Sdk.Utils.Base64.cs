...
namespace RU.Tinkoff.Acquiring.Sdk.Utils {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']"
	[global::Android.Runtime.Register ("ru/tinkoff/acquiring/sdk/utils/Base64", DoNotGenerateAcw=true)]
	public partial class Base64 : global::Java.Lang.Object {


		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/field[@name='CRLF']"
		[Register ("CRLF")]
		public const int Crlf = (int) 4;

		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/field[@name='DEFAULT']"
		[Register ("DEFAULT")]
		public const int Default = (int) 0;

		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/field[@name='NO_CLOSE']"
		[Register ("NO_CLOSE")]
		public const int NoClose = (int) 16;

		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/field[@name='NO_PADDING']"
		[Register ("NO_PADDING")]
		public const int NoPadding = (int) 1;

		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/field[@name='NO_WRAP']"
		[Register ("NO_WRAP")]
		public const int NoWrap = (int) 2;

		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/field[@name='URL_SAFE']"
		[Register ("URL_SAFE")]
		public const int UrlSafe = (int) 8;
		// Metadata.xml XPath class reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Coder']"
		[global::Android.Runtime.Register ("ru/tinkoff/acquiring/sdk/utils/Base64$Coder", DoNotGenerateAcw=true)]
		public abstract partial class Coder : global::Java.Lang.Object {


			static IntPtr op_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Coder']/field[@name='op']"
			[Register ("op")]
			public int Op {
				get {
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Coder']/field[@name='output']"
			[Register ("output")]
			...
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("ru/tinkoff/acquiring/sdk/utils/Base64$Coder", ref java_class_handle);
				}
			}
...
#pragma warning disable 0169
			...
			{
				global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Coder __this = global::Java.Lang.Object.GetObject<global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Coder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.MaxOutputSize (p0);
			}
#pragma warning restore 0169

			// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Coder']/method[@name='maxOutputSize' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Coder']/method[@name='process' and count(parameter)=4 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='boolean']]"
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Decoder']"
		[global::Android.Runtime.Register ("ru/tinkoff/acquiring/sdk/utils/Base64$Decoder", DoNotGenerateAcw=true)]
		public partial class Decoder : global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Coder {

			internal static new IntPtr java_class_handle;
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("ru/tinkoff/acquiring/sdk/utils/Base64$Decoder", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Decoder']/constructor[@name='Base64.Decoder' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='byte[]']]"
			[Register (".ctor", "(I[B)V", "")]
...
#pragma warning disable 0169
			...
			static int n_MaxOutputSize_I (IntPtr jnienv, IntPtr native__this, int p0)
			{
				global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Decoder __this = global::Java.Lang.Object.GetObject<global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Decoder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.MaxOutputSize (p0);
			}
#pragma warning restore 0169

			static IntPtr id_maxOutputSize_I;
			// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Decoder']/method[@name='maxOutputSize' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("maxOutputSize", "(I)I", "GetMaxOutputSize_IHandler")]
			public override unsafe int MaxOutputSize (int p0)
			{
				if (id_maxOutputSize_I == IntPtr.Zero)
...
#pragma warning restore 0169
			...
			static IntPtr id_process_arrayBIIZ;
			// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Decoder']/method[@name='process' and count(parameter)=4 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='boolean']]"
			[Register ("process", "([BIIZ)Z", "GetProcess_arrayBIIZHandler")]
			public override unsafe bool Process (byte[] p0, int p1, int p2, bool p3)
			{
				if (id_process_arrayBIIZ == IntPtr.Zero)
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']"
		[global::Android.Runtime.Register ("ru/tinkoff/acquiring/sdk/utils/Base64$Encoder", DoNotGenerateAcw=true)]
		public partial class Encoder : global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Coder {


			// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']/field[@name='LINE_GROUPS']"
			[Register ("LINE_GROUPS")]
			public const int LineGroups = (int) 19;

			static IntPtr do_cr_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']/field[@name='do_cr']"
			[Register ("do_cr")]
			public bool DoCr {
				get {
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']/field[@name='do_newline']"
			[Register ("do_newline")]
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']/field[@name='do_padding']"
			[Register ("do_padding")]
			...
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("ru/tinkoff/acquiring/sdk/utils/Base64$Encoder", ref java_class_handle);
				}
			}
			...
			static IntPtr id_ctor_IarrayB;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']/constructor[@name='Base64.Encoder' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='byte[]']]"
			[Register (".ctor", "(I[B)V", "")]
...
#pragma warning disable 0169
			...
			static int n_MaxOutputSize_I (IntPtr jnienv, IntPtr native__this, int p0)
			{
				global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Encoder __this = global::Java.Lang.Object.GetObject<global::RU.Tinkoff.Acquiring.Sdk.Utils.Base64.Encoder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.MaxOutputSize (p0);
			}
#pragma warning restore 0169

			static IntPtr id_maxOutputSize_I;
			// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']/method[@name='maxOutputSize' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("maxOutputSize", "(I)I", "GetMaxOutputSize_IHandler")]
			public override unsafe int MaxOutputSize (int p0)
			{
				if (id_maxOutputSize_I == IntPtr.Zero)
...
#pragma warning restore 0169
			...
			static IntPtr id_process_arrayBIIZ;
			// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64.Encoder']/method[@name='process' and count(parameter)=4 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='boolean']]"
			[Register ("process", "([BIIZ)Z", "GetProcess_arrayBIIZHandler")]
			public override unsafe bool Process (byte[] p0, int p1, int p2, bool p3)
			{
				if (id_process_arrayBIIZ == IntPtr.Zero)
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("ru/tinkoff/acquiring/sdk/utils/Base64", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/method[@name='decode' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/method[@name='decode' and count(parameter)=4 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/method[@name='decode' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/method[@name='encode' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/method[@name='encode' and count(parameter)=4 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/method[@name='encodeToString' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.utils']/class[@name='Base64']/method[@name='encodeToString' and count(parameter)=4 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
